...
export const STR = {
  en: {
    ...
    analyzing: "Analyzing your lecture… (local LLM may take ~30s)",
    s2: "2. Your level & what you know",
    level: "Level",
    goal: "Goal",
    s2hint: "Tap each concept to set how well you know it (Know it / Unsure / No idea).",
    addedNote: (n: number) => `+${n} foundation(s) your lecture assumed but didn't teach — added so we can check them too.`,
    r_confident: "Know it",
    r_unsure: "Unsure",
    r_none: "No idea",
    quiz: "Quiz",
  ...
  ko: {
    ...
    analyzing: "강의 분석 중… (로컬 LLM, ~30초 걸릴 수 있어요)",
    s2: "2. 수준과 아는 정도",
    level: "학습 수준",
    goal: "목표",
    s2hint: "각 개념을 눌러 얼마나 아는지 표시하세요 (알아요 / 가물가물 / 몰라요).",
    addedNote: (n: number) => `강의가 전제하고 안 가르친 기초 ${n}개를 추가했어요 — 함께 점검합니다.`,
    r_confident: "알아요",
    r_unsure: "가물가물",
    r_none: "몰라요",
    quiz: "퀴즈",
